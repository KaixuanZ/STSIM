...
def main(img_path1, img_path2, label, viz=True):
    ...
    if viz:
        ...
        tmp[0] = 0
        plt.plot(range(k, psd1d_fg.size), tmp[k:], label=label)
...
fg = '/Data/DareDevil/synthesized_H&B/fg_synthesized.png'
psd1d_syn_HB = main1(fg, 'synthesized film grain H&B')

# img_o = '/Data/DareDevil/denoised/frame_00300.png'
# img_den = '/Data/DareDevil/original/frame_00300.png'
# psd1d_o = main(img_o, img_den, 'original film grain')
...
# psd1d_syn0 = main(img_dec, img_ren, 'synthesized film grain')

# img_dec = '/Data/DareDevil/decoded/frame_00300.png'
# img_ren = '/Data/DareDevil/renoised_01/frame_00300.png'
# psd1d_syn1 = main(img_dec, img_ren, 'synthesized film grain')

# img_dec = '/Data/DareDevil/decoded/frame_00300.png'
# img_ren = '/Data/DareDevil/renoised_02/frame_00300.png'
# psd1d_syn2 = main(img_dec, img_ren, 'synthesized film grain')

# img_dec = '/Data/DareDevil/decoded/frame_00300.png'
# img_ren = '/Data/DareDevil/renoised_03/frame_00300.png'
# psd1d_syn3 = main(img_dec, img_ren, 'synthesized film grain')

# img_dec = '/Data/DareDevil/decoded/frame_00300.png'
# img_ren = '/Data/DareDevil/renoised_04/frame_00300.png'
# psd1d_syn4 = main(img_dec, img_ren, 'synthesized film grain')

# img_dec = '/Data/DareDevil/decoded/frame_00300.png'
# img_ren = '/Data/DareDevil/renoised_default_ps64/frame_00300.png'
# psd1d_syn5 = main(img_dec, img_ren, 'synthesized film grain')
